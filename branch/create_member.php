...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($check->fetch()) {
        ...
        <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl text-sm font-medium">
            ...
            <div>
                Membership Status: Expired (Payment Pending)
            </div>
        </div>';
    }
}
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="w-full bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 text-sm font-semibold text-slate-800">
